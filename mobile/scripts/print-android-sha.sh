...
echo ""
echo "Tip: google-services.json should contain oauth_client entries after SHA is added."
echo "     Current file has empty oauth_client — that causes auth/missing-client-identifier."
